...
*/
function map(widthTotal,heightTotal){
...
var width = widthTotal,height = heightTotal, scaleFactor= 3400;
...
function chart(){
        ...
        if(!controlsObj){
            controlsObj = controls(d3node,regions,step,finish,texts);
        }
        var helperText = [
